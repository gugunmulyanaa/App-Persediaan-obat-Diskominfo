<?php 
    ...
    if (isset($_POST['btnAdd'])) {
        ...
        if ($kd_transaksi == "" || $kd_pretransaksi == "" || $barang == ""|| $stok == "" || $jumlah == "" || $total == "") {
                        ...
                        <form method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input style="font-weight: bold; color: red;" type="hidden" class="form-control" value="<?= $transkode; ?>" readonly name="kd_transaksi">
                                </div>
                                <div class="col-md-6">
                                    <label for="">Kode Antrian</label>
                                    <input  type="hidden" class="form-control" value="<?= $antrian; ?>" readonly name="kd_pretransaksi" id="antrian">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" max="100" name="harba" value="<?php echo @$dataR['stok_barang']; ?>"  readonly="">
                                    </div>
                                    <div class="form-group">
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="form-group">
                    ...
                    <input type="text" id="myInput" class="form-control" name="jumlah"  autocomplete="off">
                </div>
