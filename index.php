...
<head>
    ...
    <!-- Fontfaces CSS-->
    <link rel="shortcut icon" href="ico/3212.png">
...
<body style="background: url(images/JON.jpg) no-repeat; background-size: cover;">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/kominfo1.png" alt="CoolAdmin">
                            </a>
                        </div>
