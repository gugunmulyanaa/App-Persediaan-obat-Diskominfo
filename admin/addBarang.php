        ...
        if ($kode_barang == " " || $nama_barang == " " || $merek_barang == " " || $distributor == " "|| $tanggal_masuk == " " || $harga == " " || $stok == " " || $foto == " " || $ket == " " ) {
            ...
            if ($harga < 0 || $stok < 0 || $harga == 0 || $stok == 0) {
                ...
                if ($response['types'] == "true") {
                    $value = "'$kode_barang','$nama_barang','$merek_barang','$distributor','$tanggal_masuk','$harga','$stok','$response[image]','$ket'";
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <input type="text"  class="form-control" name="kode_barang" value="<?php echo @$_POST['kode_barang'] ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tanggal_masuk" value="<?php echo @$_POST['tanggal_masuk'] ?>">
                                </div>
                                <div class="form-group">
