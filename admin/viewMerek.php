<?php 
    ...
    if (isset($_GET['delete'])) {
        $where = "kd_merek";
        $whereValues = $_GET['id'];
        $redirect = "?page=viewMerek";
        $response = $me->delete($table,$where,$whereValues,$redirect);
    }
            ...
            <div class="row">
                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="kode_merek" style="font-weight: bold; color: red;" value="<?php echo @$editData['kode_merek'] ?>">
                                    <?php endif ?>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                        <div class="card-header">
                            <strong class="card-title mb-3">Data Merek   </strong>
                        </div>
                        <div class="card-body">
